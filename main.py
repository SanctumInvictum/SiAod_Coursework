...
class Node:
    """
    Реализация структуры данных узла для хэш-таблицы
    """
...
class HashTable:
    """
    Структура данных - хэш таблица с рехэшированием методом цепочек
    """
...
def read_csv(file):
    ...
    Преобразует файл в двумерный массив, где каждый одномерный массив является строкой из файла
    """
    try:
...
def validate(arr):
    ...
    - Дата заказа не может быть позже текущей
    - Недопустимо отрицательное или нулевое количество товаров
    - Недопустима нулевая или отрицательная цена за единицу товара или за его итоговую стоимость
